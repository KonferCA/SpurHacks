...
export const Hero: React.FC = () => {
  ...
  const MobileCountdown = () => (
    <Flex justify="center" w="100%" mt={4} mb={6} align="center">
      ...
      <Text color="white" fontWeight="bold" fontSize="xl" lineHeight="1" mb={4}>
        :
      </Text>
  ...
  return (
    <Box position="relative" h="100vh" overflow="hidden" ref={portalRef}>
      <Box
        ...
        {isMobile ? (
          ...
          >
            <Box mb={6} maxW="300px" px={4}>
              <Image
                src={NoIconLogo || "/src/assets/logos/logo_noicon.svg"}
                alt="SPURHACKS"
                width="100%"
                height="auto"
              />

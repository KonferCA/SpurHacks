...
export const Hero: React.FC = () => {
    ...
    const SocialIcons = () => (
        <HStack position="absolute" bottom={8} right={8}>
            <Box>
                <a
                    href={heroSocialMedia.discord.url}
                    aria-label={heroSocialMedia.discord.ariaLabel}
                    target="_blank"
                ...
                >
                    ...
                    >
                        <title id="discordTitle">
                            {heroSocialMedia.discord.title}
                        </title>
            ...
            <Box>
                <a
                    href={heroSocialMedia.linkedin.url}
                    aria-label={heroSocialMedia.linkedin.ariaLabel}
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{ color: 'white', display: 'block' }}
                >
                    ...
                    >
                        <title id="linkedinTitle">
                            {heroSocialMedia.linkedin.title}
                        </title>
            ...
            <Box>
                <a
                    href={heroSocialMedia.instagram.url}
                    aria-label={heroSocialMedia.instagram.ariaLabel}
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{ color: 'white', display: 'block' }}
                >
                    ...
                    >
                        <title id="instagramTitle">
                            {heroSocialMedia.instagram.title}
                        </title>
            ...
            <Box>
                <a
                    href={heroSocialMedia.twitter.url}
                    aria-label={heroSocialMedia.twitter.ariaLabel}
                    target="_blank"
                    rel="noopener noreferrer"
                    style={{ color: 'white', display: 'block' }}
                >

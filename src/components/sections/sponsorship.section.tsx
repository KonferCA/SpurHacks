import { Alert, Heading, Text, Button, Flex } from "@chakra-ui/react";
...
export const Sponsorship = () => {
	...
	return (
		<div className="bg-black text-white min-h-screen grid place-items-center">
			<Flex className="flex flex-col gap-20 items-center justify-center w-full h-full text-center bg-[linear-gradient(to_right,rgba(255,255,255,0.15)_1px,transparent_1px),linear-gradient(to_bottom,rgba(255,255,255,0.15)_1px,transparent_1px)] [background-size:60px_60px]">
				{/* Header and Text */}
				<div className="flex flex-col items-center justify-center gap-8 max-w-3xl">
					...
					<Text>
						...
						lorem, aliquam luctus tellus viverra ut. Curabitur.
					</Text>
					<Text>
					...
					<Button
						color="brand.orange"
						// className="bg-[#FFA75F] font-semibold uppercase py-3 px-5 rounded-full text-black"
					>
						Become a sponsor
					</Button>
				</div>
				<div>
					<Alert.Root>
						...
						<Alert.Content>
							...
							<Alert.Description>test desc</Alert.Description>
						</Alert.Content>
					</Alert.Root>
				</div>
			</Flex>

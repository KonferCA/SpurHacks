...
import { strings, footerStrings } from '@locales';
                    ...
                    <HStack ml={-1} mb={{ base: 4, md: 0 }}>
                        <Box>
                            <a
                                ...
                                aria-label={strings.socials.discord.ariaLabel}
                                target="_blank"
                        ...
                        <Box>
                            <a
                                ...
                                aria-label={strings.socials.linkedin.ariaLabel}
                                target="_blank"
                                rel="noopener noreferrer"
                                style={{ color: 'white', display: 'block' }}
                            >
                                ...
                                >
                                    <title id="linkedinFooterTitle">
                                        {strings.socials.linkedin.title}
                                    </title>
                        ...
                        <Box>
                            <a
                                ...
                                aria-label={strings.socials.instagram.ariaLabel}
                                target="_blank"
                                rel="noopener noreferrer"
                                style={{ color: 'white', display: 'block' }}
                            >
                                ...
                                >
                                    <title id="instagramFooterTitle">
                                        {strings.socials.instagram.title}
                                    </title>
                        ...
                        <Box>
                            <a
                                ...
                                aria-label={strings.socials.x.ariaLabel}
                                target="_blank"
                                rel="noopener noreferrer"
                                style={{ color: 'white', display: 'block' }}
                            >

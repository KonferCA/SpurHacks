...
export const SplineProvider: React.FC<SplineProviderProps> = ({
    children,
    ...
    const mountSpline = useCallback(
        (container: HTMLDivElement | null, targetId: string | null = null) => {
    ...
    return (
        <SplineContext.Provider value={contextValue}>
            {children}
            {targetElement &&
                ReactDOM.createPortal(splineComponent, targetElement)}
